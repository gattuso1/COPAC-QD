...
Ham(3,3) = Ham(1,1)
Ham(4,4) = Ham(2,2)
Ham(5,5) = minEe(1,1) + minEh(1,1) + V0 &
                                    - elec*(a55_1d_ho + a55_2d_ho * exp(-1.0d0*(a55_3d_ho*aR(n) + a55_4d_ho*link))) &
                                  + 2*elec*(a55_1e_ho + a55_2e_ho * exp(-1.0d0*(a55_3e_ho*aR(n) + a55_4e_ho*link)))
Ham(6,6) = minEe(1,1) + minEh(2,1) + V0 - elec*(a66_1d_ho + a66_2d_ho * exp(-1.0d0*(a66_3d_ho*aR(n) + a66_4d_ho*link))) &
                                  + 2*elec*(a66_1e_ho + a66_2e_ho * exp(-1.0d0*(a66_3e_ho*aR(n) + a66_4e_ho*link)))
Ham(7,7) = Ham(5,5)
Ham(8,8) = Ham(6,6)
Ham(0,1) = 0.0d0
Ham(0,2) = 0.0d0
...
Ham(1,3) = - 1.0d0 * elec*(a13_1d_ho + a13_2d_ho * exp(-1.0d0*(a13_3d_ho*aR(n) + a13_4d_ho*link))) &
             + 2.0d0 * elec*(a13_1e_ho + a13_2e_ho * exp(-1.0d0*(a13_3e_ho*aR(n) + a13_4e_ho*link)))

Ham(1,4) = - 1.0d0 * elec*(a14_1d_ho + a14_2d_ho * exp(-1.0d0*(a14_3d_ho*aR(n) + a14_4d_ho*link))) &
             + 2.0d0 * elec*(a14_1e_ho + a14_2e_ho * exp(-1.0d0*(a14_3e_ho*aR(n) + a14_4e_ho*link)))

Ham(1,5) =  - 1.0d0 * elec*(a15_1d_ho + (a15_2d_ho/aR(n))**a15_3d_ho * exp(-1.0d0*a15_4d_ho*link)) &
             + 2.0d0 * elec*(a15_1e_ho + (a15_2e_ho/aR(n))**a15_3e_ho * exp(-1.0d0*a15_4e_ho*link))

Ham(1,6) = - 1.0d0 *( -1.0d0 * elec * (a16_1d_ho + (a16_2d_ho/aR(n))**a16_3d_ho * exp(-1.0d0*a16_4d_ho*link)) &
                     + 2.0d0 * elec * (a16_1e_ho + (a16_2e_ho/aR(n))**a16_3e_ho * exp(-1.0d0*a16_4e_ho*link)))

Ham(1,7) = - 1.0d0 * elec*(a17_1d_ho + (a17_2d_ho/aR(n))**a17_3d_ho * exp(-1.0d0*a17_4d_ho*link)) &
             + 2.0d0 * elec*(a17_1e_ho + (a17_2e_ho/aR(n))**a17_3e_ho * exp(-1.0d0*a17_4e_ho*link))

Ham(1,8) =  - 1.0d0 *( -1.0d0 * elec * (a18_1d_ho + (a18_2d_ho/aR(n))**a18_3d_ho * exp(-1.0d0*a18_4d_ho*link)) &
                      + 2.0d0 * elec * (a18_1e_ho + (a18_2e_ho/aR(n))**a18_3e_ho * exp(-1.0d0*a18_4e_ho*link)))

Ham(2,3) = Ham(1,4)

Ham(2,4) = - 1.0d0 * elec*(a24_1d_ho + a24_2d_ho * exp(-1.0d0*(a24_3d_ho*aR(n) + a24_4d_ho*link))) &
             + 2.0d0 * elec*(a24_1e_ho + a24_2e_ho * exp(-1.0d0*(a24_3e_ho*aR(n) + a24_4e_ho*link)))

Ham(2,5) =  - 1.0d0 *( -1.0d0 * elec*(a25_1d_ho + (a25_2d_ho/aR(n))**a25_3d_ho * exp(-1.0d0*a25_4d_ho*link)) &
                      + 2.0d0 * elec*(a25_1e_ho + (a25_2e_ho/aR(n))**a25_3e_ho * exp(-1.0d0*a25_4e_ho*link)))

Ham(2,6) =  - 1.0d0 * elec*(a26_1d_ho + (a26_2d_ho/aR(n))**a26_3d_ho * exp(-1.0d0*a26_4d_ho*link)) &
              + 2.0d0 * elec*(a26_1e_ho + (a26_2e_ho/aR(n))**a26_3e_ho * exp(-1.0d0*a26_4e_ho*link))

Ham(2,7) =  - 1.0d0 *( -1.0d0 * elec * (a27_1d_ho + (a27_2d_ho/aR(n))**a27_3d_ho * exp(-1.0d0*a27_4d_ho*link)) &
                      + 2.0d0 * elec * (a27_1e_ho + (a27_2e_ho/aR(n))**a27_3e_ho * exp(-1.0d0*a27_4e_ho*link)))

Ham(2,8) =  - 1.0d0 * elec*(a28_1d_ho + (a28_2d_ho/aR(n))**a28_3d_ho * exp(-1.0d0*a28_4d_ho*link)) &
              + 2.0d0 * elec*(a28_1e_ho + (a28_2e_ho/aR(n))**a28_3e_ho * exp(-1.0d0*a28_4e_ho*link))
...
Ham(5,6) = - 1.0d0 * elec*(a56_1d_ho + (a56_2d_ho/aR(n))**a56_3d_ho * exp(-1.0d0*a56_4d_ho*link)) &
             + 2.0d0 * elec*(a56_1e_ho + (a56_2e_ho/aR(n))**a56_3e_ho * exp(-1.0d0*a56_4e_ho*link))

Ham(5,7) = - 1.0d0 * elec*(a57_1d_ho + (a57_2d_ho/aR(n))**a57_3d_ho * exp(-1.0d0*a57_4d_ho*link)) &
             + 2.0d0 * elec*(a57_1e_ho + (a57_2e_ho/aR(n))**a57_3e_ho * exp(-1.0d0*a57_4e_ho*link))

Ham(5,8) = - 1.0d0 * elec*(a58_1d_ho + (a58_2d_ho/aR(n))**a58_3d_ho * exp(-1.0d0*a58_4d_ho*link)) &
             + 2.0d0 * elec*(a58_1e_ho + (a58_2e_ho/aR(n))**a58_3e_ho * exp(-1.0d0*a58_4e_ho*link))

Ham(6,7) = Ham(5,8)

Ham(6,8) = - 1.0d0 * elec*(a68_1d_ho + (a68_2d_ho/aR(n))**a68_3d_ho * exp(-1.0d0*a68_4d_ho*link)) &
             + 2.0d0 * elec*(a68_1e_ho + (a68_2e_ho/aR(n))**a68_3e_ho * exp(-1.0d0*a68_4e_ho*link))
...
TransHam(0,5) = TransDip_Fit_h1e_ho(aR(1),link)
TransHam(0,6) = TransDip_Fit_h2e_ho(aR(1),link)
...
Ham(1,2) = - 1.0 * elec*(a12_1d_he + a12_2d_he / exp((aR(n)*1d9)*a12_3d_he)) &
             + 2 * elec*(a12_1e_he + a12_2e_he / exp((aR(n)*1d9)*a12_3e_he))
...
Ham(3,4) = - 1.0 * elec*(a12_1d_he + a12_2d_he / exp((aR(n+nsys)*1d9)*a12_3d_he)) &
             + 2 * elec*(a12_1e_he + a12_2e_he / exp((aR(n+nsys)*1d9)*a12_3e_he))
