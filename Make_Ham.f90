...
Ham(5,5) = minEe(1,1) + minEh(1,1) + V0 &
                                    - elec*(a55_1d_ho + a55_2d_ho * exp(-1.0d0*(a55_3d_ho*aR(1) + a55_4d_ho*link))) &
                                  + 2*elec*(a55_1e_ho + a55_2e_ho * exp(-1.0d0*(a55_3e_ho*aR(1) + a55_4e_ho*link)))

write(6,*) aR(1), "e", minEe(1,1)/elec
write(6,*) aR(1), "h1", minEh(1,1)/elec
write(6,*) aR(1), "h2", minEh(2,1)/elec


Ham(6,6) = minEe(1,1) + minEh(2,1) + V0 - elec*(a66_1d_ho + a66_2d_ho * exp(-1.0d0*(a66_3d_ho*aR(1) + a66_4d_ho*link))) &
